...
- `Codex_Classes.md` — 5 races, 7 classes au sens du Codex (génériques + exclusives, le Mage comptant pour 1 avec 3 écoles — **implémenté comme 9 classes**, voir écart documenté ci-dessous), 38 spécialisations, restrictions d'armes/armures
