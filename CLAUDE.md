...
- **Un seul compagnon par équipe**, jamais plus, choisi après la création de tous les personnages. Accessible même en équipe solo (1 personnage). Certains compagnons nécessitent une classe précise dans l'équipe (Élan → Chasseur sylvestre, Gnome → Mage, Sanglier → Ingénieur, Fée → Demi-Orc).
