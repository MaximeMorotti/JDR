...
const objets: Objet[] = [
  ...
  { id: "brassard-cuir-gauche", nom: "Brassard en cuir (gauche)", type: "ARMURE", categorie: "ARMURE", emplacement: "BRAS_GAUCHE", palier: "COMMUN", origine: "ACHAT_VILLAGE", poidsArmure: "LEGERE", prix: 3, defense: "+1", description: "Protection légère de l'avant-bras." },
  { id: "brassard-cuir-droit", nom: "Brassard en cuir (droit)", type: "ARMURE", categorie: "ARMURE", emplacement: "BRAS_DROIT", palier: "COMMUN", origine: "ACHAT_VILLAGE", poidsArmure: "LEGERE", prix: 3, defense: "+1", description: "Identique, symétrique." },
  ...
  { id: "brassard-peau-ecailleuse-gauche", nom: "Brassard en peau écailleuse (gauche)", type: "ARMURE", categorie: "ARMURE", emplacement: "BRAS_GAUCHE", palier: "RUDIMENTAIRE", origine: "CRAFT", poidsArmure: "LEGERE", defense: "+1", description: "Craft Ingénieur — 1× Peau écailleuse (par bras). Écailles de serpent cousues sur cuir souple." },
  { id: "brassard-peau-ecailleuse-droit", nom: "Brassard en peau écailleuse (droit)", type: "ARMURE", categorie: "ARMURE", emplacement: "BRAS_DROIT", palier: "RUDIMENTAIRE", origine: "CRAFT", poidsArmure: "LEGERE", defense: "+1", description: "Craft Ingénieur — 1× Peau écailleuse (par bras). Écailles de serpent cousues sur cuir souple." },
